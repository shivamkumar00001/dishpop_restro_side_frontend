...
const MagneticButton = ({ children, className, onClick, variant = "primary", disabled = false }) => {
  const ref = useRef(null);
      ...
      <div id="main-content" className="relative z-10 pt-24">
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-wrap gap-4">
                <MagneticButton 
                  ...
                  disabled={loading}
                >
                  {loading ? 'Loading...' : 'Get Started'} <ArrowRight className="w-4 h-4 ml-2" />
                </MagneticButton>
                <MagneticButton variant="secondary">
                  Watch Demo <Play className="w-4 h-4 ml-2 fill-current" />
                </MagneticButton>
        ...
        <section className="py-32 px-4 md:px-20 lg:px-32 relative overflow-hidden bg-slate-900 text-white">
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            <div className="flex flex-col md:flex-row gap-6 justify-center items-center">
               <MagneticButton 
                 className="!bg-white !text-blue-900 !border-none !px-12 !py-4 !text-xl !shadow-2xl"
                 onClick={handleGetStarted}
                 disabled={loading}
               >
                 {loading ? 'Loading...' : 'Partner With Us'}
               </MagneticButton>
            </div>
          </div>
        </section>
